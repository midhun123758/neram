      ...
      <main className="contact-main">
        <div className="contact-card">
          ...
          <div className="contact-info-grid">
            ...
            {/* Phone 1 */}
            <a href="https://wa.me/918590415447" target="_blank" rel="noopener noreferrer" className="contact-item">
              ...
              <div>
                <div className="contact-label">WhatsApp 1</div>
                <div className="contact-value">+91 85904 15447</div>
              </div>
            </a>
            ...
            <a href="https://wa.me/919605700780" target="_blank" rel="noopener noreferrer" className="contact-item">
              ...
              <div>
                <div className="contact-label">WhatsApp 2</div>
